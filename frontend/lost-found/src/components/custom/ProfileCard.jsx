...
function ProfileCard({data}) {
  ...
  return (
    <div className="bg-white p-4 rounded-lg shadow-lg transform transition-all h-80 w-72 duration-300 ease-in-out hover:scale-105 hover:shadow-xl border hover:border-purple-900">
